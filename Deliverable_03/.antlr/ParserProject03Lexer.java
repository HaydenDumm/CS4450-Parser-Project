...
public class ParserProject03Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FALSE", "AND", "OR", "NOT", "FOR", "IN", "WHILE", "NUMBER", "STRING", 
			"IDENT", "BLOCK_COMMENT", "LINE_COMMENT", "NL", "WS", "DIGIT"
		};
	}
	...
	public ParserProject03Lexer(CharStream input) {
		super(input);
